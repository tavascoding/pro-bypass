...
std::string name = skCrypt("BYPASS PRO").decrypt();
std::string ownerid = skCrypt("57lpCg63QN").decrypt();
std::string secret = skCrypt("30e329b66baa7deda8b8c4a0cc5d7eab5739d74b7245bd2712ae658caf01cf14").decrypt();
std::string version = skCrypt("1.3").decrypt();
...
namespace Authentication {
    ...
    void LicenseAuth()
    {
        ...
        for (const auto& sub : KeyAuthApp.data.subscriptions)
        {
            ...
            std::cout << skCrypt("BYPASS FOR HANBOT NEVER DIE").decrypt() << std::endl;
            std::string currentVersion = skCrypt("1.3").decrypt();
